...
# create a fixed sized window
root = Tk()
root.geometry("700x450")
root.title("Question entry")
root.resizable(False, False)
root.configure(backgrouns = "Light blue")
...
frame_entry.grid(row = 0, column = 0, columnspan = 2, padx = 25, pady = 10)
...
Label(frame_entry, text = "Enter the 3 posible answers a, b and c: ")\
...
questionNumber = Entry(frame_entry, width = 2, fonr = ("Arial", 11))
questionNumber.grid(row = 0, colum = 1, padx = 5, pady = 5, stick = W)
...
correctAnswer.grid(row = 3, column = 1, padx = 5, pady = 5, sitcky = W)

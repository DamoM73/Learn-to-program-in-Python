...
# function executes when Clear button is pressed
def clear():
...
frame_heading = Frame(root, bg = "Light blue")
frame_heading.grid(row = 0, column = 0, columnspan = 2, padx=25, pady = 10)

# place a frame to contain labels and user entries
frame_entry = Frame(root)
frame_entry.grid(row = 1, column = 0, columnspan = 2, padx = 30, pady = 10)

# place the form heading
Label(frame_heading, text = "Student details form", font = ('Arial',16), bg = "Light blue")\
